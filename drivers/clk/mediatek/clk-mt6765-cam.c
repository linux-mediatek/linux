...
static const struct mtk_gate cam_clks[] = {
	GATE_CAM(CLK_CAM_LARB3, "cam_larb3", "mm_sel", 0),
	GATE_CAM(CLK_CAM_DFP_VAD, "cam_dfp_vad", "mm_sel", 1),
	...
	GATE_CAM(CLK_CAMSV2, "camsv2", "mm_sel", 11),
	GATE_CAM(CLK_CAM_CCU, "cam_ccu", "mm_sel", 12),
};
...
static const struct of_device_id of_match_clk_mt6765_cam[] = {
	{ .compatible = "mediatek,mt6765-camsys", .data = &cam_desc },
	{ /* sentinel */ }
};
